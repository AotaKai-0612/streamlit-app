...
def analyze_comment(comment_text):
    ...
    他者への敵意、侮辱、暴言の強さ。
    - **0: なし**: 敬意がある、または中立的。不快感を与えない。
    - **1: 低**: 小馬鹿にする、見下すような表現。軽い不快感。（例：「そんなことも知らないの？」）
    - **2: 中**: 明確な悪口、強い嘲笑。「バカ」「ゴミ」などの侮辱語が含まれる。
    - **3: 高**: **非常に激しい敵意、人格否定、または執拗な攻撃。**（※「死ね」等の最大級の暴言や、差別的表現を含む）
    ...
    - **1: 低**: 過去動画への言及など（推測可能）。
    - **2: 中**: ファン用語、ミーム、決まり文句。
    - **3: 高**: **その動画や界隈の深い知識がないと、意味が全く理解できないもの（初見殺し）。**
